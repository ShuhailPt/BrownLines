        ...
        if(value.docs.isNotEmpty){
          ...
          for(var element in value.docs) {
            ...
            if (loginUsertype == "ADMIN") {
              print("cb bcb");
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>Adminpages() ,));
            }
            else {
              print("mxnxn");


              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => bottomnavigation(Userid: uid, Username: loginUsername, Usernumber: loginphno,)));
